    ...
    async (isBackgroundRefresh = false) => {
      try {
        ...
        const response = await axios.get(
          `https://cosmetics-server-001.vercel.app/api/admin/all-brands/?${params.toString()}`
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://cosmetics-server-001.vercel.app/api/admin/delete/brand/${id}`
      );
              ...
              categories.map((category) => (
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      href={`/admin/products/add-brands/${category._id}`}
...
export default BrandAllDataAdmin;
