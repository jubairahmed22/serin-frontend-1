    ...
    async (isBackgroundRefresh = false) => {
      try {
        ...
        const response = await axios.get(
          `https://cosmetics-server-001.vercel.app/api/admin/all-skin-care/?${params.toString()}`
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://cosmetics-server-001.vercel.app/api/admin/delete/skin-care/${id}`
      );
              ...
              categories.map((category) => (
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      href={`/admin/products/add-skincare/${category._id}`}
...
export default SkinCareAllDataAdmin;
