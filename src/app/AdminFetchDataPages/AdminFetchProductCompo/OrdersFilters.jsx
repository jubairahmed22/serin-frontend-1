    ...
    <div className="grid grid-cols-4 md:grid-cols-4 gap-4">
      <div>
        ...
        <input
          ...
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-400 dark:text-black dark:placeholder-gray-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
