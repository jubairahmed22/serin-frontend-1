...
const PaginationButton = ({ page, isActive, direction, onClick }) => {
  const classNames = `relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
    isActive
      ? "z-10 bg-blue-50 border-blue-500 text-blue-600 dark:bg-white dark:border-gray-300 dark:text-gray-900"
      : "bg-white border-gray-300 text-gray-500 hover:bg-gray-50 dark:bg-white dark:border-gray-300 dark:text-gray-700 dark:hover:bg-gray-100"
  }`;
