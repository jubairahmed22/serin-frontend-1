...
const HomeBannerGridThree = () => {
    ...
    useEffect(() => {
        const fetchBannerData = async () => {
            try {
                const response = await fetch('https://cosmetics-server-001.vercel.app/api/admin/bannerThree');
                if (!response.ok) {
    ...
    return (
        <div className="max-w-[1440px] mx-auto px-4 py-8">
            <div className="gridImageBannerThree">
...
export default HomeBannerGridThree;