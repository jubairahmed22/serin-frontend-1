...
import AddCreateAuthorProfileForm from "../../Form/AddCreateAuthorProfileForm";

const ModalCreateAuthorProfile = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          <h3 className="text-xl font-semibold text-gray-800">Create Author Profile</h3>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 ">
           <AddCreateAuthorProfileForm onClose={onClose}></AddCreateAuthorProfileForm>
        </div>
      </div>
    </div>
  );
...
export default ModalCreateAuthorProfile;