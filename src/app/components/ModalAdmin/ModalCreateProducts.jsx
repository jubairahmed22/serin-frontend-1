...
const ModalCreateProducts = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 fontPoppins cursor-pointer bg-black/10 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300 ${
    ...
    >
      <div
        className={`bg-gray-50 rounded-xl shadow-2xl w-[90%]  flex flex-col overflow-hidden border border-gray-400 transform transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto  ">
           <AddProductForm onClose={onClose}></AddProductForm>
        </div>
      </div>
    </div>
  );
