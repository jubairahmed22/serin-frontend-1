...
import AddSubCategoryForm from "../../Form/AddSubCategoryForm";

const ModalCreateSubCategory = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 ">
           <AddSubCategoryForm onClose={onClose}></AddSubCategoryForm>
        </div>
      </div>
    </div>
  );
