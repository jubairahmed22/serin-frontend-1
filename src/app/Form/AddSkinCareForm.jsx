  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://cosmetics-server-001.vercel.app/api/admin/upload/create-skin-care",
        formData,
      ...
      Swal.fire({
        title: "Success!",
        text: "Skin care item added successfully.",
        icon: "success",
...
export default AddSkinCareForm;
