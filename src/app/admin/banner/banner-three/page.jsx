...
import BannerThreeAllData from "../../../AdminFetchDataPages/BannerThreeAllData";
import ModalCreateBannerThree from "../../../components/ModalAdmin/ModalCreateBannerThree";
  ...
  return (
    <div className="p-5">
      <div className="bg-white border border-gray-200 shadow flex flex-col gap-5 p-5 rounded-2xl">
        ...
        <div className="">
          <BannerThreeAllData></BannerThreeAllData>
        </div>  
      </div>
      <ModalCreateBannerThree
