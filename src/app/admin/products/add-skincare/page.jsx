...
import SkinCareAllDataAdmin from "../../../AdminFetchDataPages/SkinCareAllDataAdmin";
import ModalCreateSkinCare from "../../../components/ModalAdmin/ModalCreateSkinCare";
      ...
      <div className="bg-white border border-gray-200 shadow flex flex-col gap-5 p-5 rounded-2xl">
        <div className="flex justify-between ">
          ...
          <div>
            ...
            >
             <span className="text-xl">+</span> Create Skin Care Item
            </button>
          </div>
        </div>
        <div className="">
          <SkinCareAllDataAdmin></SkinCareAllDataAdmin>
        </div>
      </div>
      <ModalCreateSkinCare
